...
/*abstract class RecyclerAdapter<T>(
    ...
    private val loadMode = 1
    private val normal = 0
    private var mContext: Context = context

    private var mList : MutableList<T> = ArrayList()

    private val mLayoutInflayter: LayoutInflater = LayoutInflater.from(context)
    ...
    abstract fun binHolder(holder: RecyclerView.ViewHolder, position: Int)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        val view = mLayoutInflayter.inflate(layoutResource, parent, false)
